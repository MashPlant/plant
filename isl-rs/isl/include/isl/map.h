...
__isl_keep isl_ctx *isl_basic_map_get_ctx(__isl_keep isl_basic_map *bmap);
__isl_keep isl_ctx *isl_map_get_ctx(__isl_keep isl_map *map);
...
__isl_give isl_basic_map *isl_basic_map_set_tuple_name(
	__isl_take isl_basic_map *bmap, enum isl_dim_type type, __isl_keep const char *s);
__isl_keep const char *isl_basic_map_get_tuple_name(__isl_keep isl_basic_map *bmap,
	enum isl_dim_type type);
isl_bool isl_map_has_tuple_name(__isl_keep isl_map *map,
	enum isl_dim_type type);
__isl_keep const char *isl_map_get_tuple_name(__isl_keep isl_map *map,
	enum isl_dim_type type);
__isl_give isl_map *isl_map_set_tuple_name(__isl_take isl_map *map,
	enum isl_dim_type type, __isl_keep const char *s);
__isl_keep const char *isl_basic_map_get_dim_name(__isl_keep isl_basic_map *bmap,
	enum isl_dim_type type, unsigned pos);
isl_bool isl_map_has_dim_name(__isl_keep isl_map *map,
	enum isl_dim_type type, unsigned pos);
__isl_keep const char *isl_map_get_dim_name(__isl_keep isl_map *map,
	enum isl_dim_type type, unsigned pos);
...
__isl_give isl_basic_map *isl_basic_map_detect_equalities(
						__isl_take isl_basic_map *bmap);
__isl_give isl_basic_map *isl_basic_map_read_from_file(__isl_keep isl_ctx *ctx,
	__isl_keep FILE *input);
__isl_constructor
__isl_give isl_basic_map *isl_basic_map_read_from_str(__isl_keep isl_ctx *ctx,
	__isl_keep const char *str);
__isl_give isl_map *isl_map_read_from_file(__isl_keep isl_ctx *ctx, __isl_keep FILE *input);
__isl_constructor
__isl_give isl_map *isl_map_read_from_str(__isl_keep isl_ctx *ctx, __isl_keep const char *str);
...
__isl_give struct isl_map *isl_map_fix_input_si(__isl_take struct isl_map *map,
...
__isl_give isl_map *isl_map_remove_divs_involving_dims(__isl_take isl_map *map,
	enum isl_dim_type type, unsigned first, unsigned n);
__isl_give struct isl_map *isl_map_remove_inputs(__isl_take struct isl_map *map,
...
void isl_map_print_internal(__isl_keep isl_map *map, __isl_keep FILE *out, int indent);
...
isl_stat isl_map_foreach_basic_map(__isl_keep isl_map *map,
	isl_stat (*fn)(__isl_take isl_basic_map *bmap, __isl_keep void *user), __isl_keep void *user);

__isl_give isl_map *isl_map_fixed_power_val(__isl_take isl_map *map,
	__isl_take isl_val *exp);
__isl_give isl_map *isl_map_power(__isl_take isl_map *map, __isl_keep int *exact);
__isl_give isl_map *isl_map_reaching_path_lengths(__isl_take isl_map *map,
	__isl_keep int *exact);
