...
__isl_keep isl_ctx *isl_mat_get_ctx(__isl_keep isl_mat *mat);

__isl_give isl_mat *isl_mat_alloc(__isl_keep isl_ctx *ctx,
	unsigned n_row, unsigned n_col);
__isl_give struct isl_mat *isl_mat_extend(__isl_take struct isl_mat *mat,
	unsigned n_row, unsigned n_col);
__isl_give struct isl_mat *isl_mat_identity(__isl_keep struct isl_ctx *ctx, unsigned n_row);
...
void isl_mat_print_internal(__isl_keep isl_mat *mat, __isl_keep FILE *out, int indent);
