...
__isl_keep isl_ctx *isl_aff_get_ctx(__isl_keep isl_aff *aff);
...
__isl_keep const char *isl_aff_get_dim_name(__isl_keep isl_aff *aff,
	enum isl_dim_type type, unsigned pos);
...
__isl_constructor
__isl_give isl_aff *isl_aff_read_from_str(__isl_keep isl_ctx *ctx, __isl_keep const char *str);
__isl_give char *isl_aff_to_str(__isl_keep isl_aff *aff);
__isl_give isl_printer *isl_printer_print_aff(__isl_take isl_printer *p,
	__isl_keep isl_aff *aff);
void isl_aff_dump(__isl_keep isl_aff *aff);

__isl_keep isl_ctx *isl_pw_aff_get_ctx(__isl_keep isl_pw_aff *pwaff);
...
__isl_keep const char *isl_pw_aff_get_dim_name(__isl_keep isl_pw_aff *pa,
	enum isl_dim_type type, unsigned pos);
...
__isl_constructor
__isl_give isl_pw_aff *isl_pw_aff_read_from_str(__isl_keep isl_ctx *ctx, __isl_keep const char *str);
...
__isl_constructor
__isl_give isl_multi_aff *isl_multi_aff_read_from_str(__isl_keep isl_ctx *ctx,
...
__isl_keep isl_ctx *isl_pw_multi_aff_get_ctx(__isl_keep isl_pw_multi_aff *pma);
...
isl_bool isl_pw_multi_aff_has_tuple_name(__isl_keep isl_pw_multi_aff *pma,
	enum isl_dim_type type);
__isl_keep const char *isl_pw_multi_aff_get_tuple_name(__isl_keep isl_pw_multi_aff *pma,
	enum isl_dim_type type);
...
__isl_keep const char *isl_pw_multi_aff_get_dim_name(__isl_keep isl_pw_multi_aff *pma,
	enum isl_dim_type type, unsigned pos);
...
__isl_constructor
__isl_give isl_pw_multi_aff *isl_pw_multi_aff_read_from_str(__isl_keep isl_ctx *ctx,
	__isl_keep const char *str);
...
__isl_keep isl_ctx *isl_union_pw_multi_aff_get_ctx(
	__isl_keep isl_union_pw_multi_aff *upma);
__isl_export
...
isl_stat isl_union_pw_multi_aff_foreach_pw_multi_aff(
	__isl_keep isl_union_pw_multi_aff *upma,
	isl_stat (*fn)(__isl_take isl_pw_multi_aff *pma, __isl_keep void *user),
	__isl_keep void *user);
isl_bool isl_union_pw_multi_aff_every_pw_multi_aff(
	__isl_keep isl_union_pw_multi_aff *upma,
	isl_bool (*test)(__isl_keep isl_pw_multi_aff *pma, __isl_keep void *user),
	__isl_keep void *user);
__isl_export
...
__isl_constructor
__isl_give isl_multi_pw_aff *isl_multi_pw_aff_read_from_str(__isl_keep isl_ctx *ctx,
	__isl_keep const char *str);
...
__isl_keep isl_ctx *isl_union_pw_aff_get_ctx(__isl_keep isl_union_pw_aff *upa);
__isl_export
...
__isl_give isl_union_pw_aff *isl_union_pw_aff_set_dim_name(
	...
	unsigned pos, __isl_keep const char *s);
...
__isl_give isl_union_pw_aff *isl_union_pw_aff_empty_ctx(__isl_keep isl_ctx *ctx);
...
isl_stat isl_union_pw_aff_foreach_pw_aff(__isl_keep isl_union_pw_aff *upa,
	isl_stat (*fn)(__isl_take isl_pw_aff *pa, __isl_keep void *user), __isl_keep void *user);
isl_bool isl_union_pw_aff_every_pw_aff(__isl_keep isl_union_pw_aff *upa,
	isl_bool (*test)(__isl_keep isl_pw_aff *pa, __isl_keep void *user), __isl_keep void *user);
...
__isl_constructor
__isl_give isl_union_pw_aff *isl_union_pw_aff_read_from_str(__isl_keep isl_ctx *ctx,
	__isl_keep const char *str);
