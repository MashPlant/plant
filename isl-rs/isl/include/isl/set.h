...
__isl_keep isl_ctx *isl_basic_set_get_ctx(__isl_keep isl_basic_set *bset);
__isl_keep isl_ctx *isl_set_get_ctx(__isl_keep isl_set *set);
...
__isl_keep const char *isl_basic_set_get_tuple_name(__isl_keep isl_basic_set *bset);
isl_bool isl_set_has_tuple_name(__isl_keep isl_set *set);
__isl_keep const char *isl_set_get_tuple_name(__isl_keep isl_set *set);
__isl_give isl_basic_set *isl_basic_set_set_tuple_name(
	__isl_take isl_basic_set *set, __isl_keep const char *s);
__isl_give isl_set *isl_set_set_tuple_name(__isl_take isl_set *set,
	__isl_keep const char *s);
__isl_keep const char *isl_basic_set_get_dim_name(__isl_keep isl_basic_set *bset,
...
isl_bool isl_set_has_dim_name(__isl_keep isl_set *set,
	enum isl_dim_type type, unsigned pos);
__isl_keep const char *isl_set_get_dim_name(__isl_keep isl_set *set,
	enum isl_dim_type type, unsigned pos);
...
void isl_basic_set_print_internal(__isl_keep isl_basic_set *bset,
				__isl_keep FILE *out, int indent);
__isl_export
...
__isl_give isl_basic_set *isl_basic_set_read_from_file(__isl_keep isl_ctx *ctx,
	__isl_keep FILE *input);
__isl_constructor
__isl_give isl_basic_set *isl_basic_set_read_from_str(__isl_keep isl_ctx *ctx,
	__isl_keep const char *str);
__isl_give isl_set *isl_set_read_from_file(__isl_keep isl_ctx *ctx, __isl_keep FILE *input);
__isl_constructor
__isl_give isl_set *isl_set_read_from_str(__isl_keep isl_ctx *ctx, __isl_keep const char *str);
...
int isl_basic_set_compare_at(__isl_keep struct isl_basic_set *bset1,
	__isl_keep struct isl_basic_set *bset2, int pos);
...
isl_stat isl_basic_set_dims_get_sign(__isl_keep isl_basic_set *bset,
	enum isl_dim_type type, unsigned pos, unsigned n, __isl_keep int *signs);
...
__isl_give isl_set *isl_set_fix_val(__isl_take isl_set *set,
	enum isl_dim_type type, unsigned pos, __isl_take isl_val *v);
__isl_give struct isl_set *isl_set_fix_dim_si(__isl_take struct isl_set *set,
...
void isl_set_print_internal(__isl_keep isl_set *set, __isl_keep FILE *out, int indent);
...
uint32_t isl_set_get_hash(__isl_keep struct isl_set *set);

int isl_set_n_basic_set(__isl_keep isl_set *set);
__isl_export
isl_stat isl_set_foreach_basic_set(__isl_keep isl_set *set,
	isl_stat (*fn)(__isl_take isl_basic_set *bset, __isl_keep void *user), __isl_keep void *user);
__isl_give isl_basic_set_list *isl_set_get_basic_set_list(
	__isl_keep isl_set *set);

isl_stat isl_set_foreach_point(__isl_keep isl_set *set,
	isl_stat (*fn)(__isl_take isl_point *pnt, __isl_keep void *user), __isl_keep void *user);
