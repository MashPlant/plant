...
__isl_keep isl_ctx *isl_restriction_get_ctx(__isl_keep isl_restriction *restr);
...
__isl_give isl_access_info *isl_access_info_alloc(__isl_take isl_map *sink,
	__isl_keep void *sink_user, int (*fn)(__isl_keep void *first, __isl_keep void *second), int max_source);
__isl_give isl_access_info *isl_access_info_set_restrict(
	__isl_take isl_access_info *acc, __isl_give isl_restriction *(*fn)(
	__isl_keep isl_map *source_map, __isl_keep isl_set *sink,
	__isl_keep void *source_user, __isl_keep void *user), __isl_keep void *user);
__isl_give isl_access_info *isl_access_info_add_source(
	__isl_take isl_access_info *acc, __isl_take isl_map *source,
	int must, __isl_keep void *source_user);
__isl_null isl_access_info *isl_access_info_free(
	__isl_take isl_access_info *acc);

__isl_keep isl_ctx *isl_access_info_get_ctx(__isl_keep isl_access_info *acc);

__isl_give isl_flow *isl_access_info_compute_flow(__isl_take isl_access_info *acc);
isl_stat isl_flow_foreach(__isl_keep isl_flow *deps,
	isl_stat (*fn)(__isl_take isl_map *dep, int must, __isl_keep void *dep_user,
...
__isl_keep isl_ctx *isl_union_access_info_get_ctx(
	__isl_keep isl_union_access_info *access);
...
__isl_keep isl_ctx *isl_union_flow_get_ctx(__isl_keep isl_union_flow *flow);
