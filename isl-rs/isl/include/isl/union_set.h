...
__isl_overload
__isl_give isl_union_set *isl_union_set_empty_ctx(__isl_keep isl_ctx *ctx);
...
__isl_keep isl_ctx *isl_union_set_get_ctx(__isl_keep isl_union_set *uset);
__isl_export
...
isl_stat isl_union_set_foreach_set(__isl_keep isl_union_set *uset,
	isl_stat (*fn)(__isl_take isl_set *set, __isl_keep void *user), __isl_keep void *user);
__isl_export
isl_bool isl_union_set_every_set(__isl_keep isl_union_set *uset,
	isl_bool (*test)(__isl_keep isl_set *set, __isl_keep void *user), __isl_keep void *user);
...
__isl_give isl_union_set *isl_union_set_read_from_file(__isl_keep isl_ctx *ctx,
	__isl_keep FILE *input);
__isl_constructor
__isl_give isl_union_set *isl_union_set_read_from_str(__isl_keep isl_ctx *ctx,
