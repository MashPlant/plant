...
isl_stat isl_options_set_ast_iterator_type(__isl_keep isl_ctx *ctx, __isl_keep const char *val);
__isl_keep const char *isl_options_get_ast_iterator_type(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_ast_always_print_block(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_ast_always_print_block(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_ast_print_outermost_block(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_ast_print_outermost_block(__isl_keep isl_ctx *ctx);
...
__isl_keep isl_ctx *isl_ast_expr_get_ctx(__isl_keep isl_ast_expr *expr);
...
__isl_keep isl_ctx *isl_ast_node_get_ctx(__isl_keep isl_ast_node *node);
...
isl_stat isl_ast_node_foreach_descendant_top_down(
	__isl_keep isl_ast_node *node,
	isl_bool (*fn)(__isl_keep isl_ast_node *node, __isl_keep void *user), __isl_keep void *user);
...
__isl_give isl_ast_print_options *isl_ast_print_options_alloc(__isl_keep isl_ctx *ctx);
...
__isl_keep isl_ctx *isl_ast_print_options_get_ctx(
	__isl_keep isl_ast_print_options *options);
...
__isl_give isl_ast_print_options *isl_ast_print_options_set_print_user(
	...
	__isl_give isl_printer *(*print_user)(__isl_take isl_printer *p,
		__isl_take isl_ast_print_options *options,
		__isl_keep isl_ast_node *node, __isl_keep void *user),
...
isl_stat isl_options_set_ast_print_macro_once(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_ast_print_macro_once(__isl_keep isl_ctx *ctx);

isl_stat isl_ast_expr_foreach_ast_expr_op_type(__isl_keep isl_ast_expr *expr,
	isl_stat (*fn)(enum isl_ast_expr_op_type type, __isl_keep void *user), __isl_keep void *user);
