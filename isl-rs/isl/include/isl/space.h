...
__isl_keep isl_ctx *isl_space_get_ctx(__isl_keep isl_space *space);
__isl_export
__isl_give isl_space *isl_space_unit(__isl_keep isl_ctx *ctx);
__isl_give isl_space *isl_space_alloc(__isl_keep isl_ctx *ctx,
			unsigned nparam, unsigned n_in, unsigned n_out);
__isl_give isl_space *isl_space_set_alloc(__isl_keep isl_ctx *ctx,
			unsigned nparam, unsigned dim);
__isl_give isl_space *isl_space_params_alloc(__isl_keep isl_ctx *ctx, unsigned nparam);
