...
__isl_keep isl_ctx *isl_vertex_get_ctx(__isl_keep isl_vertex *vertex);
...
__isl_keep isl_ctx *isl_vertices_get_ctx(__isl_keep isl_vertices *vertices);
...
isl_stat isl_vertices_foreach_vertex(__isl_keep isl_vertices *vertices,
	isl_stat (*fn)(__isl_take isl_vertex *vertex, __isl_keep void *user), __isl_keep void *user);
__isl_null isl_vertices *isl_vertices_free(__isl_take isl_vertices *vertices);

__isl_keep isl_ctx *isl_cell_get_ctx(__isl_keep isl_cell *cell);
...
isl_stat isl_vertices_foreach_cell(__isl_keep isl_vertices *vertices,
	isl_stat (*fn)(__isl_take isl_cell *cell, __isl_keep void *user), __isl_keep void *user);
