...
__isl_export
__isl_give isl_val *isl_val_zero(__isl_keep isl_ctx *ctx);
__isl_export
__isl_give isl_val *isl_val_one(__isl_keep isl_ctx *ctx);
__isl_export
__isl_give isl_val *isl_val_negone(__isl_keep isl_ctx *ctx);
__isl_export
__isl_give isl_val *isl_val_nan(__isl_keep isl_ctx *ctx);
__isl_export
__isl_give isl_val *isl_val_infty(__isl_keep isl_ctx *ctx);
__isl_export
__isl_give isl_val *isl_val_neginfty(__isl_keep isl_ctx *ctx);
__isl_constructor
__isl_give isl_val *isl_val_int_from_si(__isl_keep isl_ctx *ctx, long i);
__isl_give isl_val *isl_val_int_from_ui(__isl_keep isl_ctx *ctx, unsigned long u);
__isl_give isl_val *isl_val_int_from_chunks(__isl_keep isl_ctx *ctx, size_t n,
	size_t size, __isl_keep const void *chunks);

__isl_give isl_val *isl_val_copy(__isl_keep isl_val *v);
__isl_null isl_val *isl_val_free(__isl_take isl_val *v);

__isl_keep isl_ctx *isl_val_get_ctx(__isl_keep isl_val *val);
...
__isl_constructor
__isl_give isl_val *isl_val_read_from_str(__isl_keep isl_ctx *ctx, __isl_keep const char *str);
...
__isl_constructor
__isl_give isl_multi_val *isl_multi_val_read_from_str(__isl_keep isl_ctx *ctx,
