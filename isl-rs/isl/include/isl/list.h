...
__isl_keep isl_ctx *isl_##EL##_list_get_ctx(__isl_keep isl_##EL##_list *list);	\
CONSTRUCTOR								\
__isl_give isl_##EL##_list *isl_##EL##_list_from_##EL(			\
	__isl_take isl_##EL *el);					\
CONSTRUCTOR								\
__isl_give isl_##EL##_list *isl_##EL##_list_alloc(__isl_keep isl_ctx *ctx, int n);	\
...
isl_stat isl_##EL##_list_foreach(__isl_keep isl_##EL##_list *list,	\
	isl_stat (*fn)(__isl_take isl_##EL *el, __isl_keep void *user),		\
	__isl_keep void *user);							\
isl_bool isl_##EL##_list_every(__isl_keep isl_##EL##_list *list,	\
	isl_bool (*test)(__isl_keep isl_##EL *el, __isl_keep void *user),		\
	__isl_keep void *user);							\
...
isl_stat isl_##EL##_list_foreach_scc(__isl_keep isl_##EL##_list *list,	\
	isl_bool (*follows)(__isl_keep struct isl_##EL *a,		\
			__isl_keep struct isl_##EL *b, __isl_keep void *user),	\
	__isl_keep void *follows_user,						\
	isl_stat (*fn)(__isl_take isl_##EL##_list *scc, __isl_keep void *user),	\
	__isl_keep void *fn_user);							\
