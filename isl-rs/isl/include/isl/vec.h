...
__isl_give isl_vec *isl_vec_alloc(__isl_keep isl_ctx *ctx, unsigned size);
__isl_give isl_vec *isl_vec_zero(__isl_keep isl_ctx *ctx, unsigned size);
__isl_give isl_vec *isl_vec_copy(__isl_keep isl_vec *vec);
__isl_null isl_vec *isl_vec_free(__isl_take isl_vec *vec);

__isl_keep isl_ctx *isl_vec_get_ctx(__isl_keep isl_vec *vec);
...
__isl_give struct isl_vec *isl_vec_normalize(__isl_take struct isl_vec *vec);
...
__isl_give isl_vec *isl_vec_read_from_file(__isl_keep isl_ctx *ctx, __isl_keep FILE *input);
