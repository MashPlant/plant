...
__isl_keep isl_ctx *isl_schedule_node_get_ctx(__isl_keep isl_schedule_node *node);
...
isl_bool isl_schedule_node_every_descendant(__isl_keep isl_schedule_node *node,
	isl_bool (*test)(__isl_keep isl_schedule_node *node, __isl_keep void *user),
	__isl_keep void *user);
__isl_export
isl_stat isl_schedule_node_foreach_ancestor_top_down(
	__isl_keep isl_schedule_node *node,
	isl_stat (*fn)(__isl_keep isl_schedule_node *node, __isl_keep void *user),
	__isl_keep void *user);
__isl_export
...
isl_stat isl_options_set_tile_scale_tile_loops(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_tile_scale_tile_loops(__isl_keep isl_ctx *ctx);
isl_stat isl_options_set_tile_shift_point_loops(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_tile_shift_point_loops(__isl_keep isl_ctx *ctx);
