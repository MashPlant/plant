...
__isl_keep isl_ctx *isl_local_space_get_ctx(__isl_keep isl_local_space *ls);
...
__isl_keep const char *isl_local_space_get_dim_name(__isl_keep isl_local_space *ls,
	enum isl_dim_type type, unsigned pos);
