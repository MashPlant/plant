...
isl_stat isl_options_set_ast_build_atomic_upper_bound(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_ast_build_atomic_upper_bound(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_ast_build_prefer_pdiv(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_ast_build_prefer_pdiv(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_ast_build_detect_min_max(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_ast_build_detect_min_max(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_ast_build_exploit_nested_bounds(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_ast_build_exploit_nested_bounds(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_ast_build_group_coscheduled(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_ast_build_group_coscheduled(__isl_keep isl_ctx *ctx);

#define ISL_AST_BUILD_SEPARATION_BOUNDS_EXPLICIT		0
#define ISL_AST_BUILD_SEPARATION_BOUNDS_IMPLICIT		1
isl_stat isl_options_set_ast_build_separation_bounds(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_ast_build_separation_bounds(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_ast_build_scale_strides(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_ast_build_scale_strides(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_ast_build_allow_else(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_ast_build_allow_else(__isl_keep isl_ctx *ctx);
...
__isl_constructor
__isl_give isl_ast_build *isl_ast_build_alloc(__isl_keep isl_ctx *ctx);
__isl_export
...
__isl_give isl_ast_build *isl_ast_build_set_at_each_domain(
	...
	__isl_give isl_ast_node *(*fn)(__isl_take isl_ast_node *node,
		__isl_keep isl_ast_build *build, __isl_keep void *user), __isl_keep void *user);
