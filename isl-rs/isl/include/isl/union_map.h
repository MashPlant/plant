...
__isl_overload
__isl_give isl_union_map *isl_union_map_empty_ctx(__isl_keep isl_ctx *ctx);
...
__isl_keep isl_ctx *isl_union_map_get_ctx(__isl_keep isl_union_map *umap);
__isl_export
...
isl_stat isl_union_map_foreach_map(__isl_keep isl_union_map *umap,
	isl_stat (*fn)(__isl_take isl_map *map, __isl_keep void *user), __isl_keep void *user);
__isl_give isl_map_list *isl_union_map_get_map_list(
	__isl_keep isl_union_map *umap);
__isl_export
isl_bool isl_union_map_every_map(__isl_keep isl_union_map *umap,
	isl_bool (*test)(__isl_keep isl_map *map, __isl_keep void *user), __isl_keep void *user);
__isl_give isl_union_map *isl_union_map_remove_map_if(
	__isl_take isl_union_map *umap,
	isl_bool (*fn)(__isl_keep isl_map *map, __isl_keep void *user), __isl_keep void *user);
...
__isl_give isl_union_map *isl_union_map_transitive_closure(
	__isl_take isl_union_map *umap, __isl_keep isl_bool *exact);
...
__isl_give isl_union_map *isl_union_map_read_from_file(__isl_keep isl_ctx *ctx,
	__isl_keep FILE *input);
__isl_constructor
__isl_give isl_union_map *isl_union_map_read_from_str(__isl_keep isl_ctx *ctx,
