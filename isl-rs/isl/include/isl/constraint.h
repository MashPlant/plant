...
__isl_keep isl_ctx *isl_constraint_get_ctx(__isl_keep isl_constraint *c);
...
__isl_give struct isl_constraint *isl_constraint_copy(__isl_keep struct isl_constraint *c);
...
isl_stat isl_basic_map_foreach_constraint(__isl_keep isl_basic_map *bmap,
	isl_stat (*fn)(__isl_take isl_constraint *c, __isl_keep void *user), __isl_keep void *user);
...
int isl_constraint_is_equal(__isl_keep struct isl_constraint *constraint1,
			    __isl_keep struct isl_constraint *constraint2);
...
isl_stat isl_basic_set_foreach_bound_pair(__isl_keep isl_basic_set *bset,
	...
	isl_stat (*fn)(__isl_take isl_constraint *lower,
		  ...
		  __isl_take isl_basic_set *bset, __isl_keep void *user), __isl_keep void *user);
...
isl_bool isl_basic_set_has_defining_equality(
	__isl_keep struct isl_basic_set *bset, enum isl_dim_type type, int pos,
	__isl_give struct isl_constraint **constraint);
isl_bool isl_basic_set_has_defining_inequalities(
	__isl_keep struct isl_basic_set *bset, enum isl_dim_type type, int pos,
	__isl_give struct isl_constraint **lower,
	__isl_give struct isl_constraint **upper);

__isl_give isl_space *isl_constraint_get_space(
	__isl_keep isl_constraint *constraint);
__isl_give isl_local_space *isl_constraint_get_local_space(
	__isl_keep isl_constraint *constraint);
int isl_constraint_dim(__isl_keep struct isl_constraint *constraint,
	enum isl_dim_type type);

isl_bool isl_constraint_involves_dims(__isl_keep isl_constraint *constraint,
	enum isl_dim_type type, unsigned first, unsigned n);

__isl_keep const char *isl_constraint_get_dim_name(__isl_keep isl_constraint *constraint,
	enum isl_dim_type type, unsigned pos);
...
__isl_give struct isl_constraint *isl_constraint_negate(__isl_take struct isl_constraint *constraint);
