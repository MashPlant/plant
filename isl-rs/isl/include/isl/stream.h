...
struct isl_token;
typedef struct isl_token isl_token;

__isl_give isl_val *isl_token_get_val(__isl_keep isl_ctx *ctx, __isl_keep struct isl_token *tok);
__isl_give char *isl_token_get_str(__isl_keep isl_ctx *ctx, __isl_keep struct isl_token *tok);
int isl_token_get_type(__isl_keep struct isl_token *tok);
void isl_token_free(__isl_take struct isl_token *tok);

struct isl_stream;
typedef struct isl_stream isl_stream;

__isl_give isl_stream *isl_stream_new_file(__isl_keep isl_ctx *ctx, __isl_keep FILE *file);
__isl_give isl_stream *isl_stream_new_str(__isl_keep isl_ctx *ctx, __isl_keep const char *str);
void isl_stream_free(__isl_take isl_stream *s);

__isl_keep isl_ctx *isl_stream_get_ctx(__isl_keep isl_stream *s);

void isl_stream_error(__isl_keep isl_stream *s, __isl_keep struct isl_token *tok,
	__isl_keep const char *msg);

__isl_give struct isl_token *isl_stream_next_token(__isl_keep isl_stream *s);
__isl_give struct isl_token *isl_stream_next_token_on_same_line(__isl_keep isl_stream *s);
int isl_stream_next_token_is(__isl_keep isl_stream *s, int type);
void isl_stream_push_token(__isl_keep isl_stream *s, __isl_take struct isl_token *tok);
void isl_stream_flush_tokens(__isl_keep isl_stream *s);
int isl_stream_eat_if_available(__isl_keep isl_stream *s, int type);
__isl_give char *isl_stream_read_ident_if_available(__isl_keep isl_stream *s);
...
__isl_give isl_schedule *isl_stream_read_schedule(__isl_keep isl_stream *s);
