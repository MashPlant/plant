...
__isl_give isl_printer *isl_printer_to_file(__isl_keep isl_ctx *ctx, __isl_keep FILE *file);
__isl_give isl_printer *isl_printer_to_str(__isl_keep isl_ctx *ctx);
__isl_null isl_printer *isl_printer_free(__isl_take isl_printer *printer);

__isl_keep isl_ctx *isl_printer_get_ctx(__isl_keep isl_printer *printer);
__isl_keep FILE *isl_printer_get_file(__isl_keep isl_printer *printer);
