...
isl_stat isl_options_set_schedule_max_coefficient(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_schedule_max_coefficient(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_schedule_max_constant_term(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_schedule_max_constant_term(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_schedule_maximize_band_depth(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_schedule_maximize_band_depth(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_schedule_maximize_coincidence(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_schedule_maximize_coincidence(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_schedule_outer_coincidence(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_schedule_outer_coincidence(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_schedule_split_scaled(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_schedule_split_scaled(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_schedule_treat_coalescing(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_schedule_treat_coalescing(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_schedule_separate_components(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_schedule_separate_components(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_schedule_serialize_sccs(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_schedule_serialize_sccs(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_schedule_whole_component(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_schedule_whole_component(__isl_keep isl_ctx *ctx);

isl_stat isl_options_set_schedule_carry_self_first(__isl_keep isl_ctx *ctx, int val);
int isl_options_get_schedule_carry_self_first(__isl_keep isl_ctx *ctx);
...
__isl_keep isl_ctx *isl_schedule_constraints_get_ctx(
	__isl_keep isl_schedule_constraints *sc);
__isl_export
...
__isl_give isl_schedule_constraints *isl_schedule_constraints_read_from_str(
	__isl_keep isl_ctx *ctx, __isl_keep const char *str);
__isl_give isl_schedule_constraints *isl_schedule_constraints_read_from_file(
	__isl_keep isl_ctx *ctx, __isl_keep FILE *input);
...
__isl_keep isl_ctx *isl_schedule_get_ctx(__isl_keep isl_schedule *sched);
...
isl_stat isl_schedule_foreach_schedule_node_top_down(
	...
	isl_bool (*fn)(__isl_keep isl_schedule_node *node, __isl_keep void *user),
...
__isl_give isl_schedule *isl_schedule_map_schedule_node_bottom_up(
	...
	__isl_give isl_schedule_node *(*fn)(
		__isl_take isl_schedule_node *node, __isl_keep void *user), __isl_keep void *user);
...
__isl_give isl_schedule *isl_schedule_read_from_file(__isl_keep isl_ctx *ctx, __isl_keep FILE *input);
__isl_constructor
__isl_give isl_schedule *isl_schedule_read_from_str(__isl_keep isl_ctx *ctx,
	__isl_keep const char *str);
