...
static TILE_MAP: [([u32; 6], [u32; 12]); 26] = [
  ...
  // ([3, 64, 224, 7, 2, 3], [32, 1, 1, 1, 1, 1, 16, 1, 7, 1, 1, 1]),
  ([64, 64, 56, 1, 1, 0], [2, 2, 1, 1, 1, 2, 56, 1, 1, 1, 1, 1]),
  // ([64, 64, 56, 3, 1, 1], [2, 32, 1, 1, 1, 2, 56, 1, 1, 32, 3, 1]),
  ([64, 256, 56, 1, 1, 0], [4, 2, 4, 1, 2, 1, 8, 1, 1, 4, 1, 1]),
  ([256, 64, 56, 1, 1, 0], [4, 2, 4, 1, 1, 8, 14, 2, 2, 4, 1, 1]),
  ([256, 128, 56, 1, 2, 0], [4, 32, 1, 1, 1, 1, 14, 1, 2, 32, 1, 1]),
  // ([128, 128, 28, 3, 1, 1], [2, 8, 4, 2, 1, 14, 14, 1, 2, 32, 3, 3]),
  ([128, 512, 28, 1, 1, 0], [4, 2, 16, 1, 2, 1, 14, 1, 2, 4, 1, 1]),
  ([256, 512, 56, 1, 2, 0], [4, 64, 2, 1, 1, 2, 14, 1, 2, 16, 1, 1]),
  ([512, 128, 28, 1, 1, 0], [1, 8, 4, 1, 1, 1, 14, 2, 1, 1, 1, 1]),
  ([512, 256, 28, 1, 2, 0], [4, 16, 1, 1, 2, 7, 14, 1, 1, 8, 1, 1]),
  // ([256, 256, 14, 3, 1, 1], [4, 1, 2, 2, 1, 7, 14, 1, 1, 2, 1, 3]),
  ([256, 1024, 14, 1, 1, 0], [16, 1, 2, 2, 1, 1, 14, 1, 1, 64, 1, 1]),
  ([512, 1024, 28, 1, 2, 0], [4, 32, 1, 1, 1, 2, 14, 1, 1, 32, 1, 1]),
  ([1024, 256, 14, 1, 1, 0], [2, 4, 16, 2, 1, 1, 14, 1, 1, 8, 1, 1]),
  ([1024, 512, 14, 1, 2, 0], [8, 8, 1, 1, 1, 1, 7, 1, 1, 64, 1, 1]),
  // ([512, 512, 7, 3, 1, 1], [4, 1, 4, 7, 1, 1, 7, 1, 1, 1, 3, 1]),
  ([512, 2048, 7, 1, 1, 0], [2, 16, 1, 1, 7, 1, 1, 7, 1, 4, 1, 1]),
  ([1024, 2048, 14, 1, 2, 0], [8, 8, 1, 1, 1, 1, 7, 1, 1, 64, 1, 1]),
  ([2048, 512, 7, 1, 1, 0], [4, 1, 128, 7, 1, 1, 7, 1, 1, 4, 1, 1]),
];
